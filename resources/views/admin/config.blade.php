...
<div class="uk-width-medium-1-2 uk-column-divider">     
    ...
    <div class="">
        <input type="text" class="uk-input uk-form-width-medium"  name="forum.services.disqus.site_name" placeholder="" value="{{ config('rvsitebuilder/larecipe.forum.services.disqus.site_name') }}">
    </div> 
</div>   
<hr>
<div class="uk-column-1-2 uk-column-divider">
    ...
    <div class=""> 
        <input type="text" class="uk-input uk-form-width-medium"  name="versions.default" placeholder="master" value="{{ config('rvsitebuilder/larecipe.versions.default') }}">
    </div>
 
    <label>{{ __('rvsitebuilder/larecipe::default.index.docs-all-versions') }}</label>
    <div class=""> 
        @php $versions = implode(",", config('rvsitebuilder/larecipe.versions.published')) @endphp
    <input type="text" class="uk-input uk-form-width-medium" name="versions.published" placeholder="master" value="{{$versions}}">
    </div>
</div>
<hr>
<div class="uk-column-1-2 uk-column-divider">
    ...
    <div class="">
        @php $languages = implode(",", config('rvsitebuilder/larecipe.languages.published')) @endphp
        <input type="text" class="uk-input uk-form-width-medium" name="languages.published" placeholder="en,th,ja"   
         value="@if(!empty($languages)){{$languages}}@else {{config('rvsitebuilder/larecipe.languages.default')}}@endif">
    </div> 
</div> 